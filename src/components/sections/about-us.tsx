    ...
    return (
        <section id='nosotros' className='relative shadow-slate-800'>
            ...
            <div className='flex px-12 py-20 md:px-20 bg-black'>
                <ul className='flex flex-col gap-8 text-white md:flex-row md:flex-wrap md:w-[60vw] lg:w-[70vw] 2xl:w-[80vw]'>
            ...
            <div className='relative px-12 py-20 bg-primary md:px-20 mt-10' >
                ...
                <svg className='absolute -top-[88px] left-0 z-5' preserveAspectRatio="none" width="100%" height="88" viewBox="0 0 1280 88" fill="none" xmlns="http://www.w3.org/2000/svg" >
                ...
                <div className='relative z-10' >
                    ...
                    <div className='absolute hidden right-0 bottom-64 md:block xl:bottom-44' >
